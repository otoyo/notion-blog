...
export const INDEX_PAGE_ID = import.meta.env.INDEX_PAGE_ID || process.env.INDEX_PAGE_ID || ''
export const SUBSCRIPTION_PAGE_ID = import.meta.env.SUBSCRIPTION_PAGE_ID || process.env.SUBSCRIPTION_PAGE_ID || ''

export const CUSTOM_DOMAIN = import.meta.env.CUSTOM_DOMAIN || process.env.CUSTOM_DOMAIN || 'alpacat.com' // <- Set your costom domain if you have. e.g. alpacat.com
